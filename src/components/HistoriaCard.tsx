...
export default function HistoriaCard({ plan, onDelete }: Props) {
  ...
  return (
    <div
      className="relative rounded-xl overflow-hidden border border-[#2A2A2A] aspect-[3/4]"
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 p-4">
        <span className="text-[#C9B99A]/60 text-[10px] uppercase tracking-widest font-medium block mb-1.5">
          Historia
        </span>
      ...
      {confirming && (
        <div className="absolute inset-0 z-20 bg-black/85 flex flex-col items-center justify-center gap-4 p-5">
