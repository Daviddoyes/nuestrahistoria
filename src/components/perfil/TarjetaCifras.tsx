...
const etiqueta: React.CSSProperties = {
  fontSize: 10, textTransform: 'uppercase', letterSpacing: '0.12em', color: '#7A8A85', marginTop: 6,
}
...
export default function TarjetaCifras({ conquistados, puntos }: Props) {
  ...
  return (
    <div style={{ background: '#161817', borderRadius: 16, padding: 18 }}>
      <div style={{ display: 'flex', alignItems: 'stretch' }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          <p className="fuente-titular" style={{ fontSize: 46, fontWeight: 800, color: '#FFFFFF', lineHeight: 1 }}>
            {conquistados}
          </p>
        ...
        <div style={{ flexShrink: 0, display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
          <p className="fuente-titular" style={{ fontSize: 30, fontWeight: 700, color: '#00D1A7', lineHeight: 1 }}>
            {puntos}
          </p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', gap: 12, marginTop: 18 }}>
      ...
      <div
        ...
        style={{ height: 5, background: '#2A2E2C', borderRadius: 999, overflow: 'hidden', marginTop: 8 }}
      >
